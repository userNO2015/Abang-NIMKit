...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        _nameLabel.textColor = [UIColor colorWithRed:41/255.0 green:50/255.0 blue:64/255.0 alpha:1.0];
        ...
        _messageLabel.textColor       = [UIColor colorWithRed:110/255.0 green:122/255.0 blue:146/255.0 alpha:1.0];
        [self.contentView addSubview:_messageLabel];
        
        _timeLabel = [[UILabel alloc] initWithFrame:CGRectZero];
        _timeLabel.backgroundColor = [UIColor clearColor];
        _timeLabel.font            = [UIFont systemFontOfSize:14.f];
        _timeLabel.textColor       = [UIColor colorWithRed:110/255.0 green:122/255.0 blue:146/255.0 alpha:1.0];
